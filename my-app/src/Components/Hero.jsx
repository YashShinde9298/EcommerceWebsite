    ...
    return (<div className="container pt-8">
        <div className="grid xl:grid-cols-3 xl:grid-rows-2 gap-8">
            <div className="relative xl:col-span-2 xl:row-start-1 xl:row-end-[-1]">
                <img className="w-full h-full object-cover rounded-lg" alt="hero" src={"../../img/hero1.jpg"} />
            ...
            <div className="relative">
                <img className="w-full h-full object-cover rounded-lg" src={"../../img/burger.jpg"} alt="hero" />
                <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
                    <h2 className="text-2xl sm:text-3xl font-bold text-white">Best Yummy Burger</h2>
            ...
            <div className="relative">
                <img className="w-full h-full object-cover rounded-lg" src={"../../img/chips.jpg"} alt="hero" />
                <div className="absolute max-w-[470px] sm:ml-16 ml-8 top-[50%] -translate-y-[50%] sm:space-y-2">
